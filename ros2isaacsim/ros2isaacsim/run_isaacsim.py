...
# Optional people/navmesh/replicator imports. Keep them out of the default idle
# bridge because these extensions are heavy and have shown RSS growth on Isaac 4.5.
if ENABLE_PEOPLE_STACK or ENABLE_NAVMESH:
